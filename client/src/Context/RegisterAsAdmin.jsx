                ...
                <form noValidate onSubmit={handleSubmit} className={validated ? "was-validated" : ""}>
                    <div className="name">
                        ...
                        <input
                            ...
                            required
                        />
                        <div className="invalid-feedback invalid-feedback-name">Name is required!</div>
                    </div>
                    ...
                    <div className="security">
                        <label className="sec-code-l" htmlFor="securityCode">Security Code</label>
                        <input
                            className="sec-code-i form-control"
                            type="text"
                            id="securityCode"
                            ...
                            required
                        />
                        <div className="invalid-feedback invalid-feedback-security">Security code is required!</div>
                    </div>

                    <button className="sign-in-btn btn btn-primary" type="submit">Sign In</button>
                </form>
            </div>
        </div>
    );
