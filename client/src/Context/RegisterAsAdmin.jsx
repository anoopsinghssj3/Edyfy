    ...
    return (
        ...
        <div className="register-as-admin">
            ...
            <div className="container">
                ...
                {/* <svg className="visibility" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" type="button">
                ...
                <svg className="visibility" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
